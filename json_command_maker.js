...
function textchage(element_text) {
  ...
  while (true) {
    ...
    //如果找到粗體代碼
      ...
      text = text.replaceAll(
        text.substring(index_bold, index_reset + 7),
        "<strong>" + text.substring(index_bold + 7, index_reset) + "</strong>§r"
      );
    }
  }
  ...
  for (i = 1; i < textlist.length; i++) {
    if (textlist[i].substring(0, 1) == "1") {
      textlist[i] =
        '<p style="color:#0000AA;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "0") {
      textlist[i] =
        '<p style="color:#000000;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "2") {
      textlist[i] =
        '<p style="color:#00AA00;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "3") {
      textlist[i] =
        '<p style="color:#00AAAA;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "4") {
      textlist[i] =
        '<p style="color:#AA0000;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "5") {
      textlist[i] =
        '<p style="color:#AA00AA;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "6") {
      textlist[i] =
        '<p style="color:#FFAA00;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "7") {
      textlist[i] =
        '<p style="color:#AAAAAA;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "8") {
      textlist[i] =
        '<p style="color:#555555;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "9") {
      textlist[i] =
        '<p style="color:#5555FF;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "a") {
      textlist[i] =
        '<p style="color:#55FF55;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "b") {
      textlist[i] =
        '<p style="color:#55FFFF;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "c") {
      textlist[i] =
        '<p style="color:#FF5555;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "d") {
      textlist[i] =
        '<p style="color:#FF55FF;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    if (textlist[i].substring(0, 1) == "e") {
      textlist[i] =
        '<p style="color:#FFFF55;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
    ...
    if (textlist[i].substring(0, 1) == "g") {
      textlist[i] =
        '<p style="color:#DDD605;display:inline;">' +
        textlist[i].toString().substring(1, textlist[i].toString().length) +
        "</p>";
    }
  }
